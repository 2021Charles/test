...
if not st.session_state.get("url_synced", False):
    try:
        ...
        print(f'pickup hour 0 : {pickup_hour}')
    except KeyError:
        pass
...
def update_query_params():
    ...
    print(f'pickup hour 1 : {hour_selected}')


with row1_1:
    # st.title("NYC Uber Ridesharing Data")
    st.title("뉴욕 Uber Ridesharing Data")
...
st.altair_chart(
    ...
    .encode(
        x=alt.X("minute:Q", scale=alt.Scale(nice=False)),   # Q:quantity i.e number, T: Time variable
        y=alt.Y("pickups:Q"),
