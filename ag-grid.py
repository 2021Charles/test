...
print(f'sample:{sample_size} grid_height:{grid_height}')

return_mode = st.sidebar.selectbox("Return Mode", list(DataReturnMode.__members__), index=1)
return_mode_value = DataReturnMode.__members__[return_mode]
print(f'return_mode:{return_mode} return_mode_value:{return_mode_value}')
...
print(f'update_mode:{update_mode} update_mode_value:{update_mode_value}')
...
print(f'selected_rows :{selected}')
